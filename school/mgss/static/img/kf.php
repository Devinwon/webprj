	...
	var powered_by_53kf_url = 'http://www.53kf.com/53kfkefu.html?yx_from=53KF02',
			powered_by_53kf_txt = 'Powered by 53KF';var kf_success=1; var kftype=2;	// 获取cookie值 
	...
	var hz6d_from_page = hz6d_getCookie("53kf_70824690_keyword");
	if (hz6d_from_page == "")
	{
		hz6d_from_page = document.referrer;
		document.cookie = "53kf_70824690_keyword=" + hz6d_from_page;
	}
	...
	function hasdoctype()
  {
	...
	function setIsinvited()
	{
		try
		{
			...
			if (acc_autotype == 3)
			{
				document.cookie = "onliner_zdfq70824690=" + onliner_zdfq;
			}
		}
		catch (e)
		{}
	}
	var onliner_zdfq = hz6d_getCookie("onliner_zdfq70824690"); // onliner_zdfq: 0.初始值 2.点击接受 3.点击拒绝 
	if (onliner_zdfq == "")
	{
		onliner_zdfq = 0;
		document.cookie = "onliner_zdfq70824690=" + onliner_zdfq;
	...
	// 加载ivt.php，即中间的接受邀请层 
	if (!hz6d$("ivt_script"))
		document.write("<scr"+"ipt src='http://www3.53kf.com/kf_ivt.php?arg=tgjy&test_do=&style=1&isonline=0&kfonline=0&lang=cn&resize=yes&charset=gbk&kflist=off&kf=&zdkf_type=1&referer=http%3A%2F%2Fwww.tgjy.cn%2F"+hz6d_from_page+"&lytype=0&tpl_name=crystal_blue&tpl_width=703&tpl_height=473' type='text/javascript' id='ivt_script'></scr"+"ipt>");  
	...
	if (kf_script_num <= 1)
  {
      ...
      for (var i = 0; i < element_arrs.length; i++)
      {
        ...
        else
        {
					...
					switch (tmp_e_type)
          {
            ...
            case 'etel': click_str = 'window.open(\'http://chat.53kf.com/eht.php?company_id=70824690&style_id=103773464\',\'_blank\',\'height=400,width=300,top=100,left=200,status=yes,toolbar=no,menubar=no,resizable=no,scrollbars=no,location=no,titlebar=no\')'; break;
    ...
    var input_name_arr = input_name_str.split('#'); // 初始化解码数组 
          ...
          if ("1,\u5916\u6846,-,156,300,-,-,1,-,no-repeat,-,-,-,-,12,-,left,-,-,-,\u5b8b\u4f53,none,-,-,-,_blank#2,\u5934\u90e8\u80cc\u666f,-,156,174,0,0,1,\/img\/kflogo\/zdytb\/new2011_01\/zdytb_53kf_1313702560.gif,no-repeat,-,-,-,-,12,-,-,-,-,-,\u5b8b\u4f53,none,-,-,-,_blank#3,53KF\u80cc\u666f,chat,156,31,0,174,4,\/img\/kflogo\/zdytb\/new2011_01\/zdytb_53kf_1313704648.gif,no-repeat,-,-,-,-,12,-,-,-,-,-,\u5b8b\u4f53,none,-,-,-,_blank#4,QQ\u80cc\u666f,qq,156,31,0,205,5,\/img\/kflogo\/zdytb\/new2011_01\/zdytb_53kf_1313704634.gif,no-repeat,-,97559766,-,-,12,-,-,-,-,-,\u5b8b\u4f53,none,-,-,-,_blank#5,\u65fa\u65fa\u80cc\u666f,wang,156,31,0,236,6,\/img\/upload\/tgjy\/zdytb\/zdytb_53kf_1343785448.gif,no-repeat,-,fonlue,-,-,12,-,left,-,-,-,\u5b8b\u4f53,none,-,-,-,_blank#6,MSN\u80cc\u666f,msn,156,31,0,267,7,\/img\/upload\/tgjy\/zdytb\/zdytb_53kf_1343785459.gif,no-repeat,-,fonlue@hotmail.com,-,-,12,-,left,-,-,-,\u5b8b\u4f53,none,-,-,-,_blank#7,\u5728\u7ebf\u5f62\u8c61,chat,121,120,17,49,8,\/img\/kflogo\/zdytb\/new2011_01\/zdytb_53kf_1313714260.gif,no-repeat,-,-,-,-,12,-,-,-,-,-,\u5b8b\u4f53,none,-,-,-,_blank#8,53KF,chat,106,22,36,178,9,-,no-repeat,-,-,zdy,\u5728\u7ebf\u54a8\u8be2\u62a5\u540d,14,0059AB,center,-,-,-,\u5b8b\u4f53,none,-,-,-,_blank#9,\u7f51\u6559QQ\u54a8\u8be2,qq,106,22,36,209,10,-,no-repeat,-,1275873845,zdy,\u6210\u8003QQ\u54a8\u8be2,14,0059AB,center,-,-,-,\u5b8b\u4f53,none,-,-,-,_blank#10,\u8003\u7814QQ\u54a8\u8be2,qq,106,22,36,240,11,-,no-repeat,-,1669741218,zdy,\u81ea\u8003QQ\u54a8\u8be2,14,0059AB,center,-,-,-,\u5b8b\u4f53,none,-,-,-,_blank#11,\u8bc1\u4e66QQ\u54a8\u8be2,qq,106,22,36,271,12,-,no-repeat,-,1012147550,zdy,\u7f51\u6559QQ\u54a8\u8be2,14,0059AB,center,-,-,-,\u5b8b\u4f53,none,-,-,-,_blank#12,\u5ba2\u670dLOGO,-,22,20,9,8,13,\/img\/kflogo\/zdytb\/new2011_01\/zdytb_53kf_1313707580.gif,no-repeat,-,-,-,-,12,-,-,-,-,-,\u5b8b\u4f53,none,-,-,-,_blank#13,\u6807\u9898,-,120,24,30,5,14,-,no-repeat,-,-,zdy,\u7f51\u4e0a\u5728\u7ebf\u62a5\u540d,14,FFFFFF,center,-,-,-,\u5b8b\u4f53,none,-,-,-,_blank#14,\u672a\u547d\u540d,-,0,0,0,0,14,-,no-repeat,-,-,zdy,-,12,-,left,-,-,-,\u5b8b\u4f53,none,-,-,-,_blank" == '' || "1,\u5916\u6846,-,156,300,-,-,1,-,no-repeat,-,-,-,-,12,-,left,-,-,-,\u5b8b\u4f53,none,-,-,-,_blank#2,\u5934\u90e8\u80cc\u666f,-,156,174,0,0,1,\/img\/kflogo\/zdytb\/new2011_01\/zdytb_53kf_1313702560.gif,no-repeat,-,-,-,-,12,-,-,-,-,-,\u5b8b\u4f53,none,-,-,-,_blank#3,53KF\u80cc\u666f,chat,156,31,0,174,4,\/img\/kflogo\/zdytb\/new2011_01\/zdytb_53kf_1313704648.gif,no-repeat,-,-,-,-,12,-,-,-,-,-,\u5b8b\u4f53,none,-,-,-,_blank#4,QQ\u80cc\u666f,qq,156,31,0,205,5,\/img\/kflogo\/zdytb\/new2011_01\/zdytb_53kf_1313704634.gif,no-repeat,-,97559766,-,-,12,-,-,-,-,-,\u5b8b\u4f53,none,-,-,-,_blank#5,\u65fa\u65fa\u80cc\u666f,wang,156,31,0,236,6,\/img\/upload\/tgjy\/zdytb\/zdytb_53kf_1343785448.gif,no-repeat,-,fonlue,-,-,12,-,left,-,-,-,\u5b8b\u4f53,none,-,-,-,_blank#6,MSN\u80cc\u666f,msn,156,31,0,267,7,\/img\/upload\/tgjy\/zdytb\/zdytb_53kf_1343785459.gif,no-repeat,-,fonlue@hotmail.com,-,-,12,-,left,-,-,-,\u5b8b\u4f53,none,-,-,-,_blank#7,\u5728\u7ebf\u5f62\u8c61,chat,121,120,17,49,8,\/img\/kflogo\/zdytb\/new2011_01\/zdytb_53kf_1313714260.gif,no-repeat,-,-,-,-,12,-,-,-,-,-,\u5b8b\u4f53,none,-,-,-,_blank#8,53KF,chat,106,22,36,178,9,-,no-repeat,-,-,zdy,\u5728\u7ebf\u54a8\u8be2\u62a5\u540d,14,0059AB,center,-,-,-,\u5b8b\u4f53,none,-,-,-,_blank#9,\u7f51\u6559QQ\u54a8\u8be2,qq,106,22,36,209,10,-,no-repeat,-,1275873845,zdy,\u6210\u8003QQ\u54a8\u8be2,14,0059AB,center,-,-,-,\u5b8b\u4f53,none,-,-,-,_blank#10,\u8003\u7814QQ\u54a8\u8be2,qq,106,22,36,240,11,-,no-repeat,-,1669741218,zdy,\u81ea\u8003QQ\u54a8\u8be2,14,0059AB,center,-,-,-,\u5b8b\u4f53,none,-,-,-,_blank#11,\u8bc1\u4e66QQ\u54a8\u8be2,qq,106,22,36,271,12,-,no-repeat,-,1012147550,zdy,\u7f51\u6559QQ\u54a8\u8be2,14,0059AB,center,-,-,-,\u5b8b\u4f53,none,-,-,-,_blank#12,\u5ba2\u670dLOGO,-,22,20,9,8,13,\/img\/kflogo\/zdytb\/new2011_01\/zdytb_53kf_1313707580.gif,no-repeat,-,-,-,-,12,-,-,-,-,-,\u5b8b\u4f53,none,-,-,-,_blank#13,\u6807\u9898,-,120,24,30,5,14,-,no-repeat,-,-,zdy,\u7f51\u4e0a\u5728\u7ebf\u62a5\u540d,14,FFFFFF,center,-,-,-,\u5b8b\u4f53,none,-,-,-,_blank#14,\u672a\u547d\u540d,-,0,0,0,0,14,-,no-repeat,-,-,zdy,-,12,-,left,-,-,-,\u5b8b\u4f53,none,-,-,-,_blank" == ''  || "no" == 'no')
          {
	...
	}		if (typeof(kf_icons) == "undefined")
		{
			...
			function hishow(id, img_url)
			{
				...
				if (hz6d$(divname).style.display == "none")
				{
					...
					hz6d$("arrow" + id).src = "http://www3.53kf.com/" + img_url + "arrow1.gif";
				}
				else
				{
					hz6d$(divname).style.display = "none";
					hz6d$("arrow" + id).src = "http://www3.53kf.com/" + img_url + "arrow2.gif";
				}
			}
      ...
      function _getClickUrl()
      {
        ...
        return _click_str;
			...
			function _closeIcon()
			{
				...
				{
					str_onmove = "onmousemove='this.style.backgroundImage=\"url(http://www3.53kf.com/img/kflist/list_close_move.gif)\"' onmouseout='this.style.backgroundImage=\"url(http://www3.53kf.com/img/kflogo/close.gif)\"'";
				}
				if (0 == 1 || 70824690 == 600603 || 70824690 == 61393572 || 70824690 == 1413303 || 70824690 == 61389920 || 70824690 == 61420906 || 70824690 == 61578368)
				{
					if (2 == 1)
					{
						//return "<img onclick='kf_icons["+this.config["id"]+"].hidden()' style='position:absolute; right:0px;top:0px; cursor:pointer;' src='http://www3.53kf.com/img/kflogo/close.gif' "+str_onmove+" />";
						...
						return "<div onclick='kf_icons[" + this.config["id"] + "].hidden()' style='" + str_wh + "background:url(\"http://www3.53kf.com/img/kflogo/close.gif\") no-repeat;position:absolute;right:0px;top:0px;cursor:pointer;' " + str_onmove + " ></div>";
					}
					//return "<img onclick='kf_icons["+this.config["id"]+"].hidden()' style='position:absolute; right:0px;top:0px; cursor:pointer;' src='http://www3.53kf.com/img/kflogo/close.gif' />";
					return "<div onclick='kf_icons[" + this.config["id"] + "].hidden()' style='width:11px;height:11px;background:url(\"http://www3.53kf.com/img/kflogo/close.gif\") no-repeat;position:absolute;right:0px;top:0px;cursor:pointer;' ></div>";
				}
				return "";
			};
		...
		kf_icons[kf_icon_id].config["arg"] = "tgjy";
		//kf_icons[kf_icon_id].config["logo_id"]="2";
    ...
    if (2 == 2)kf_icons[kf_icon_id].config["zdytb_on_arrs"] = init_zdytb_arr("1,\u5916\u6846,-,125,89,-,-,1,-,no-repeat,-,-,-,-,12,-,-,-,-,none,\u5b8b\u4f53,-,-,-,-,_blank#2,\u5728\u7ebf\u56fe\u6807,chat,125,89,0,0,2,http:\/\/www3.53kf.com\/img\/kflogo\/v5_01.gif,no-repeat,-,-,zdy,-,12,000000,-,-,-,none,\u5b8b\u4f53,-,-,-,-,_blank");
    if (2 == 2)kf_icons[kf_icon_id].config["zdytb_off_arrs"] = init_zdytb_arr("1,\u5916\u6846,-,125,89,-,-,1,-,no-repeat,-,-,-,-,12,-,-,-,-,none,\u5b8b\u4f53,-,-,-,-,_blank#2,\u79bb\u7ebf\u56fe\u6807,chat,125,89,0,0,2,http:\/\/www3.53kf.com\/img\/kflogo\/v5_01_off.gif,no-repeat,-,-,zdy,-,12,000000,-,-,-,none,\u5b8b\u4f53,-,-,-,-,_blank");
		kf_icons[kf_icon_id].config["img_on"] = "http://www3.53kf.com/img/kflogo/v5_01.gif";
		kf_icons[kf_icon_id].config["img_off"] = "http://www3.53kf.com/img/kflogo/v5_01_off.gif";
		kf_icons[kf_icon_id].config["height"] = "89";
		...
		kf_icons[kf_icon_id].config["referer"] = "&referer=http%3A%2F%2Fwww.tgjy.cn%2F";
		...
		var hz6d_zdyurl = "http://www.tgjy.cn/53.htm?arg=tgjy&style=1&kflist=off&kf=&zdkf_type=1&language=cn&charset=gbk&lytype=0&referer=http%3A%2F%2Fwww.tgjy.cn%2F{hz6d_keyword}&tpl=crystal_blue";
		hz6d_zdyurl = hz6d_html_replace(hz6d_zdyurl);
		kf_icons[kf_icon_id].config["zdyurl"] = hz6d_zdyurl;
		kf_icons[kf_icon_id].config["is_zdyurl"] = "1";
		kf_icons[kf_icon_id].config["path"] = "http://chat.53kf.com";
		kf_icons[kf_icon_id].config["server_path"] = "http://www3.53kf.com";
		...
		document.write("<scr"+"ipt src='http://www3.53kf.com/stat.php?com_id=70824690&referer=http%3A%2F%2Fwww.tgjy.cn%2F"+hz6d_from_page+"' type='text/javascript' id='stat_script'></scr"+"ipt>");