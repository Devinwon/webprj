...
class UserProfile(models.Model):
    ...
    realname=models.CharField(max_length=50,null=True,blank=True,default='普通用户')
    profile_image=models.FileField(upload_to='profile_image',default='/static/images/default.png')
    GENDER_CHOICES=(
        ('male','男'),
        ('female','女'),
    )
